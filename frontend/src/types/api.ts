...
export type QuestionType = 'single_choice' | 'word_form' | 'sentence_rewriting' | 'listening_single_choice' | 'listening_true_false' | 'reading_longtext_single_choice' | 'cloze_single_choice'
