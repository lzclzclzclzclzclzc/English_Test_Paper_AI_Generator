  ...
  return (
    <div className="max-w-[56rem]">
      ...
      <section className="mt-10 max-w-md border-t border-hairline pt-7">
        <h2 className="font-heading text-[17px] font-bold text-ink">每日新词目标</h2>
        <div className="mt-4 flex items-center gap-3">
          <input className="h-8 w-24 rounded-sm border border-ink-20 bg-transparent px-2 text-ink outline-none focus:border-ink" type="number" min="10" max="50" value={limit} onChange={(event) => setLimit(Number(event.target.value))} />
