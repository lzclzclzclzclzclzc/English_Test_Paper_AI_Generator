...
CREATE TABLE IF NOT EXISTS knowledge_points (
    ...
    level1        TEXT NOT NULL
                    CHECK (level1 IN ('single_choice', 'word_form', 'sentence_rewriting', 'listening_single_choice', 'listening_true_false', 'reading_longtext_single_choice', 'cloze_single_choice')),
...
CREATE TABLE IF NOT EXISTS questions (
    ...
    question_type       TEXT NOT NULL
                          CHECK (question_type IN ('single_choice', 'word_form', 'sentence_rewriting', 'listening_single_choice', 'listening_true_false', 'reading_longtext_single_choice', 'cloze_single_choice')),
