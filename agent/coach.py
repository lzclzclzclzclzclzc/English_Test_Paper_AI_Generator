...
from agent.tools import get_example_questions, get_user_history, generate_paper, implement_study_plan, get_vocabulary_status
...
def create_coach_agent() -> Agent:
    ...
    return Agent(
        ...
        tools=[get_user_history, get_example_questions, generate_paper, implement_study_plan, get_vocabulary_status],
        model=_build_model(),
    )
